...
const LocalItem = () => {
  const description =
    "Discusses Web development for sites that are dynamic, " +
  ...
  return (
    ...
    <div className="col-10 col-md-8 col-lg-6 col-xl-6">
      ...
      <div className="ms-2 fw-bold" style={{ fontSize: 20 }}>
        CS 5610
      </div>
      <div className="ms-2 fw-semibold" style={{ fontSize: 20 }}>
        Web Development
      </div>
      <br />
      ...
      <div className="ms-2 me-3 fw-bold">
        Related information from Wikipedia (do we need this?)
      </div>
